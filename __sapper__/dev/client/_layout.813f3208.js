...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(span, file, 61, 16, 1950);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 57, 10, 1647);
		},
		m: function mount(target, anchor) {
